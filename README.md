...
Open `index.html` in je browser. De gegevens worden lokaal opgeslagen op je toestel via `localStorage`.

## Volgende uitbreidingen

- maandfilters en historiek
- export naar CSV
- apart overzicht voor vaste en variabele kosten
